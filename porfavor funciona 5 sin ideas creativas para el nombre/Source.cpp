...
int main() {
	...
	while (a != 4) {
		...
		case 3:
			...
			for (int i = j; i < - 1; i++)
			{
				dentista[i].nombre = dentista[i + 1].nombre;
				dentista[i].edad = dentista[i + 1].edad;
				dentista[i].tratamiento = dentista[i + 1].tratamiento;
				dentista[i].descripcion = dentista[i + 1].descripcion;
				dentista[i].fecha = dentista[i + 1].fecha;
				dentista[i].hora = dentista[i + 1].hora;
				dentista[i].precio = dentista[i + 1].precio;
...
void modificar()
{
	...
	cin >> i;
	i = i - 1;
	cout << "Digite el numero que contenga el dato a modificar" << endl << "1.-Nombre" << endl << "2.- Tratamiento" << endl << "3.- Sintomas y descripcion del tratamiento" << endl << "4.- Cantidad del tratamiento " << endl << "5.- Coste Unitario" << endl << "6.-Fecha" << "7.-Hora" << endl;
	cin >> opcion;
